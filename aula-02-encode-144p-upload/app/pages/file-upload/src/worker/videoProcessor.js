export default class VideoProcessor {
     ...
     * @param {import('./service').default} options.service
     */
        ...
        return new ReadableStream({
            start: async (controller) => {
                ...
                const decoder = new VideoDecoder({
                    ...
                    error(e) {
                        console.error('error at decode', e);
                        controller.error(e);
                    }
                });
        ...
        return new TransformStream({
            start: (controller) => {
                _decoder = new VideoDecoder({
                    ...
                    error(e) {
                        console.error('error at render frame', e);
                        controller.error(e);
                    }
                })
            },
            ...
            async transform(encodedChunk, controller) {
                ...
                // needs the encoded version to use webM
    ...
    encode144p(encoderConfig) {
        ...
        const readable = new ReadableStream({
            start: async (controller) => {
                ...
                if (!supported) {
                    console.error('mp4Muxer VideoEncoder config not supported', encoderConfig);
                    return;
                }
